...
public class WitherAssembler extends SlimefunItem {
			...
			public void newInstance(final BlockMenu menu, final Block b) {
				try {
					if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getBlockInfo(b, "enabled") == null || BlockStorage.getBlockInfo(b, "enabled").equals("false")) {
						menu.replaceExistingItem(22, new CustomItem(new MaterialData(Material.SULPHUR), "&7运行状态: &4\u2718", "", "&8-> &6点击 &7运行"));
						...
						menu.replaceExistingItem(22, new CustomItem(new MaterialData(Material.REDSTONE), "&7运行状态: &4\u2714", "", "&8-> &6点击 &7停止"));
						menu.addMenuClickHandler(22, new MenuClickHandler() {
					...
					menu.replaceExistingItem(31, new CustomItem(new MaterialData(Material.PISTON_BASE), "&7高度: &3" + offset + " 格", "", "&r左键: &7+0.1", "&r右键: &7-0.1"));
	...
	private void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(1, new CustomItem(new MaterialData(Material.SKULL_ITEM, (byte) 1), "&8[ &d凋零骷髅头槽 &8]", "", "&8◇ &7此处放入凋零骷髅"),
		new MenuClickHandler() {
		...
		preset.addItem(7, new CustomItem(new MaterialData(Material.SOUL_SAND), "&8[ &9灵魂沙槽 &8]", "", "&8◇ &7此处放入灵魂沙"),
		new MenuClickHandler() {
		...
		preset.addItem(13, new CustomItem(new MaterialData(Material.WATCH), "&7冷却时间: &b30 &7秒", "", "&8◇ &7此设备每隔 &630 &7秒制造一个凋零"),
		new MenuClickHandler() {
