...
public class Talisman extends SlimefunItem {
	...
	public ItemStack upgrade() {
		...
		ItemStack item = new CustomItem(getItem().getType(), "&8[&5末影&8] " + ChatColor.stripColor(getItem().getItemMeta().getDisplayName()), getItem().getDurability(), lore.toArray(new String[lore.size()]));
		return item;
	}
