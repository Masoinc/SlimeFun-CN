...
public class SlimefunSetup {
	...
	public static void setupItems() throws Exception {
		...
		.register(true, new ItemInteractionHandler() {
			...
			public boolean onRightClick(ItemUseEvent e, Player p, ItemStack item) {
				if (SlimefunManager.isItemSimiliar(item, SlimefunItems.PORTABLE_DUSTBIN, true)) {
					e.setCancelled(true);
					p.openInventory(Bukkit.createInventory(null, 9 * 3, ChatColor.DARK_RED + "  &c删除物品"));
		...
		new ItemStack[] {null, null, null, null, new ItemStack(Material.FENCE), null, null, new CustomItem(Material.DISPENSER, "发射器 &8(&6朝上放置&8)", 0), null},
		...
		new ItemStack[] {null, null, null, null, new ItemStack(Material.ANVIL), null, null, new CustomItem(Material.DISPENSER, "发射器 &8(&6朝上放置&8)", 0), null},
		new ItemStack[] {},
		Material.ANVIL)
		.register(true, new MultiBlockInteractionHandler() {
		...
		new ItemStack[] {null, null, null, null, new ItemStack(Material.NETHER_FENCE), null, new ItemStack(Material.IRON_FENCE), new CustomItem(Material.DISPENSER, "发射器 &8(&6朝上放置&8)", 0), new ItemStack(Material.IRON_FENCE)},
		...
		new ItemStack[] {null, null, null, null, new ItemStack(Material.NETHER_FENCE), null, new ItemStack(Material.PISTON_BASE), new CustomItem(Material.DISPENSER, "发射器 &8(&6朝上放置&8)", 0), new ItemStack(Material.PISTON_BASE)},
		...
		new ItemStack[] {null, new ItemStack(Material.NETHER_FENCE), null, new ItemStack(Material.NETHER_BRICK), new CustomItem(Material.DISPENSER, "发射器 &8(&6朝上放置&8)", 0), new ItemStack(Material.NETHER_BRICK), null, new ItemStack(Material.FLINT_AND_STEEL), null},
		...
		new ItemStack[] {new ItemStack(Material.STEP), new CustomItem(Material.DISPENSER, "发射器 &8(&6朝下放置&8)", 0), new ItemStack(Material.STEP), new ItemStack(Material.PISTON_BASE), new ItemStack(Material.GLASS), new ItemStack(Material.PISTON_BASE), new ItemStack(Material.PISTON_BASE), new ItemStack(Material.CAULDRON_ITEM), new ItemStack(Material.PISTON_BASE)},
		...
		new String[] {"mode.0.enabled", "mode.0.name", "mode.0.item", "mode.1.enabled", "mode.1.name", "mode.1.item", "mode.2.enabled", "mode.2.name", "mode.2.item", "mode.3.enabled", "mode.3.name", "mode.3.item"}, new Object[] {true, "便携式合成台", "PORTABLE_CRAFTER", true, "注魔末影之眼", "MAGIC_EYE_OF_ENDER", true, "&6元素法杖 &7- &2风", "STAFF_ELEMENTAL_WIND", true, "钩爪", "GRAPPLING_HOOK"})
		.register(true);
		...
		new String[] {"mode.0.enabled", "mode.0.name", "mode.0.item", "mode.1.enabled", "mode.1.name", "mode.1.item", "mode.2.enabled", "mode.2.name", "mode.2.item", "mode.3.enabled", "mode.3.name", "mode.3.item", "mode.4.enabled", "mode.4.name", "mode.4.item"}, new Object[] {true, "便携式合成台", "PORTABLE_CRAFTER", true, "注魔末影之眼", "MAGIC_EYE_OF_ENDER", true, "&6元素法杖 &7- &2风", "STAFF_ELEMENTAL_WIND", true, "钩爪", "GRAPPLING_HOOK", true, "淘金盘", "GOLD_PAN"})
		.register(true);
		...
		new ItemStack[] {null, new ItemStack(Material.GLASS), null, null, new ItemStack(Material.NETHER_FENCE), null, null, new CustomItem(Material.DISPENSER, "发射器 &8(&6朝上放置&8)", 0), null},
		new ItemStack[] {
		...
		new ItemStack[] {SlimefunItems.RUNE_ENDER, new CustomItem(Material.EXP_BOTTLE, "&6注魔经验之瓶", 0), SlimefunItems.ESSENCE_OF_AFTERLIFE, new CustomItem(Material.EXP_BOTTLE, "&6注魔经验之瓶", 0), SlimefunItems.BROKEN_SPAWNER, new CustomItem(Material.EXP_BOTTLE, "&6注魔经验之瓶", 0), SlimefunItems.ESSENCE_OF_AFTERLIFE, new CustomItem(Material.EXP_BOTTLE, "&6注魔经验之瓶", 0), SlimefunItems.RUNE_ENDER})
		...
		.register(true, new ItemInteractionHandler() {
			...
			public boolean onRightClick(ItemUseEvent e, Player p, ItemStack item) {
				if (SlimefunManager.isItemSimiliar(item, SlimefunItems.TOME_OF_KNOWLEDGE_SHARING, true)) {
					...
					lore.set(0, ChatColor.translateAlternateColorCodes('&', "&8◇ &7所有者: &3" + p.getName()));
		...
		.register(true, new ItemInteractionHandler() {
			...
			public boolean onRightClick(ItemUseEvent e, Player p, ItemStack item) {
				if (SlimefunManager.isItemSimiliar(item, SlimefunItems.FLASK_OF_KNOWLEDGE, true) && p.getLevel() >= 1) {
					...
					p.getInventory().addItem(new CustomItem(Material.EXP_BOTTLE, "&9经验储存装置", 0));
					PlayerInventory.consumeItemInHand(p);
					PlayerInventory.update(p);
					return true;
				}
			...
			public boolean onRightClick(ItemUseEvent e, Player p, ItemStack item) {
				if (SlimefunManager.isItemSimiliar(e.getItem(), SlimefunItems.MULTIMETER, true)) {
					if (e.getClickedBlock() != null && ChargableBlock.isChargable(e.getClickedBlock())) {
						e.setCancelled(true);
						p.sendMessage("");
						p.sendMessage(ChatColor.translateAlternateColorCodes('&', "&8◇ &7目前电能: &3" + DoubleHandler.getFancyDouble(ChargableBlock.getCharge(e.getClickedBlock())) + " J"));
						p.sendMessage(ChatColor.translateAlternateColorCodes('&', "&8◇ &7电能容量: &3" + DoubleHandler.getFancyDouble(ChargableBlock.getMaxCharge(e.getClickedBlock())) + " J"));
						p.sendMessage("");
					}
					return true;
				}
		...
		SlimefunItem.registerBlockHandler("HOLOGRAM_PROJECTOR", new SlimefunBlockHandler() {
			...
			@Override
			public void onPlace(Player p, Block b, SlimefunItem item) {
				BlockStorage.addBlockInfo(b, "text", "&6这是默认投影，右键投影仪进行修改");
		...
		SlimefunItem.registerBlockHandler("ELEVATOR_PLATE", new SlimefunBlockHandler() {
			...
			@Override
			public void onPlace(Player p, Block b, SlimefunItem item) {
				BlockStorage.addBlockInfo(b, "floor", "&60 &7楼");
				BlockStorage.addBlockInfo(b, "owner", p.getUniqueId().toString());
			}
