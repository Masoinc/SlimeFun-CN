...
public class Projector {
	...
	public static void openEditor(Player p, final Block projector) {
		ChestMenu menu = new ChestMenu(" 全息投影设置");
		
		menu.addItem(0, new CustomItem(new MaterialData(Material.NAME_TAG), "&8[ &6修改文字 &8]", "", "&r" + ChatColor.translateAlternateColorCodes('&', BlockStorage.getBlockInfo(projector, "text"))));
		...
		menu.addItem(1, new CustomItem(new MaterialData(Material.WATCH), "&7目前高度: &e" + DoubleHandler.fixDouble(Double.valueOf(BlockStorage.getBlockInfo(projector, "offset")) + 1.0D), "", "&8-> &6左键&7: &2+0.1", "&8-> &6右键&7 &2-0.1"));
